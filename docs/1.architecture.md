...
│   │   ├── 001-separation-of-llm.md # LLM依存を排除した技術的決断の記録
│   │   ├── 002-state-isolation.md    # GameStateを純粋集約器に隔離した技術的決断の記録
│   │   └── 003-real-time-simulation.md # 物理定数を分離し、リアルタイム駆動させた技術的決断の記録
│   │
